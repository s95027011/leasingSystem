# Generated by Django 3.2.16 on 2022-12-26 05:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('0', '配送中'), ('1', '尚未配送'), ('2', '已送達'), ('3', '訂單不成立')], default='1', help_text='商品狀態', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_id', models.CharField(blank=True, help_text='前三碼 銀行, 後四碼 分支機構', max_length=7, validators=[django.core.validators.MinLengthValidator(7), leasing.models.only_int])),
                ('card_type', models.CharField(choices=[('v', 'VISA'), ('m', 'Master')], max_length=1)),
                ('card_id', models.CharField(blank=True, help_text='16碼', max_length=16, validators=[django.core.validators.MinLengthValidator(16), leasing.models.only_int])),
                ('due_date', models.CharField(blank=True, max_length=4, validators=[django.core.validators.MinLengthValidator(4), leasing.models.only_int])),
                ('valid_number', models.CharField(blank=True, max_length=3, validators=[django.core.validators.MinLengthValidator(3), leasing.models.only_int])),
            ],
        ),
        migrations.CreateModel(
            name='Type',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_status', models.CharField(choices=[('0', '刪除'), ('1', '保留')], default='1', help_text='Type 狀態', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_status', models.CharField(choices=[('0', '刪除'), ('1', '保留')], default='1', help_text='Type 狀態', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='leasing.member')),
